...
int main()
{
  ...
  for ( auto const& benchmark : epfl_benchmarks() )
  {
    ...
    mockturtle::node_map<mockturtle::label_t, mockturtle::klut_network> node_to_label = detect_lut_merging<true>( klut_3_inv, mergable_luts_map );
    std::string filename = fmt::format( "results_lbf/multi-space/{}.lbf", benchmark );
