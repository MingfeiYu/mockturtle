...
void create_db_x1g_crypto_thread2( std::string const& filename )
{
    ...
    std::ofstream db_gc;
    db_gc.open( "db_gc_x1g_crypto_thread2", std::ios::app );
    db_gc << "0x" << repr_str << " ";
    db_gc << "0x" << tt_str << " ";
    //db_gc << mc << " ";
    db_gc << num_vars << " ";
...
int main()
{
	mockturtle::create_db_x1g_crypto_thread2( "collected_funcs_crypto" );
