...
void create_db_practical_x1g_6_thread0( std::string const& filename )
{
    ...
    std::ofstream db_gc;
    db_gc.open( "db_gc_practical_x1g_6_thread0", std::ios::app );
    db_gc << "0x" << repr_str << " ";
    db_gc << "0x" << tt_str << " ";
    //db_gc << mc << " ";
    db_gc << num_vars << " ";
...
int main()
{
	mockturtle::create_db_practical_x1g_6_thread0( "../experiments/db_mc" );
